"""Train a binary classifier on a dataset of images.

This script allows for cross-validation training, fine-tuning,
and testing on a separate dataset.
It also supports drawing precision-recall curves and analyzing false positives.
"""
...
def main(args: argparse.Namespace) -> None:
    """Main function to train a binary classifier on a dataset.
    ...
    best_model = wandb.restore(
        "simclr_model_epoch_28.weights.h5", run_path="freja-thoresen/SimCLR/nozw921x"
    )
